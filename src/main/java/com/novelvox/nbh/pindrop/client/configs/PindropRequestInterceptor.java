...
@Log4j2
@Component
public class PindropRequestInterceptor implements RequestInterceptor {

    private static final String TAG = "OAuthToken >> ";
    private static final String AUTHORIZATION = "Authorization";
    private static final String BEARER_TOKEN_TYPE = "Bearer";
    private static final String CLIENT_REGISTRATION_ID = "Pindrop";

    private final OAuth2AuthorizedClientManager authorizedClientManager;

    public PindropRequestInterceptor(OAuth2AuthorizedClientManager authorizedClientManager) {
